...
final class QuestionSupportController extends AbstractController
{
    ...
    #[Route('/{id}/edit', name: 'app_reponse_support_edit', methods: ['GET', 'POST'])]
    public function reponse(Request $request, QuestionSupport $questionSupport, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_reponse_support_index', [], Response::HTTP_SEE_OTHER);
        }
